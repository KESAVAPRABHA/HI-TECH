          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <p className="text-gray-600 mb-4">
                Founded in 2020, Hi-Tech UPVC Windows has grown to become a trusted name in the UPVC windows and doors industry. With 5 years of excellence, we have established ourselves as a reliable provider of premium quality products that enhance the beauty, security, and energy efficiency of homes and commercial spaces.
              </p>
              
              <p className="text-gray-600 mb-4">
                Our journey began with a simple mission: to provide high-quality UPVC windows and doors that meet the diverse needs of our customers. Over the years, we have expanded our product range and services, always maintaining our commitment to quality and customer satisfaction.
              </p>
              
              <p className="text-gray-600">
                Today, we take pride in our team of skilled professionals who are dedicated to delivering excellence in every project. From design to installation, we ensure that our customers receive the best products and services that exceed their expectations.
              </p>
            </motion.div>
